...
def cadastro_presidente_view():
    ...
    def cadastrar_presidente(e):
        ...
        try:
            ...
            if not (10 <= numero_int <= 99): 
                mensagem.value = "O número do presidente deve ser um inteiro de 2 dígitos (ex: 13, 22)."
                e.page.update()
                return
        except ValueError:
            mensagem.value = "O número do presidente deve ser um valor numérico válido."
            e.page.update()
            return
